# A selection of "fast" of all 160 caret models for multi-class classification and iris set
...
"gaussprLinear","gaussprPoly","rFerns","sddaLDA", "smda", "sddaQDA", "xgbLinear","xgbTree",
...
"FRBCS.W", "FRBCS.CHI","evtree","bstTree","bagEarthGCV","bagFDA","rrlda")
